                    ...
                    <div class="col-lg-4">
                        <div class="single-team-one">
                            ...
                            <div class="text-block">
                                ...
                                <p>Taxi Driver</p>
                                <div class="social-block">
                                    <a href="http://ashik.templatepath.net/conexi-preview-files/driver.html#"><i class="fa fa-twitter"></i></a>
                                    <a href="http://ashik.templatepath.net/conexi-preview-files/driver.html#"><i class="fa fa-facebook-f"></i></a>
                                    <a href="http://ashik.templatepath.net/conexi-preview-files/driver.html#"><i class="fa fa-youtube-play"></i></a>
                                </div><!-- /.social-block -->
                            </div><!-- /.text-block -->
                        </div><!-- /.single-team-one -->
                    </div><!-- /.col-lg-4 -->
